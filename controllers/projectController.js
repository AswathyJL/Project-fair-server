...
exports.addProjectController =async (req,res) => {
    ...
    try{
        ...
        if(existingProject)
        {
            res.status(406).json("Project already exists in your collection.. Please upload another!!!")
        }
        else{
...
// get Home project - no need for authorization
...
// get all project -  need for authorization
...
// get user project -  need for authorization
...
exports.removeProjectController = async(req,res)=>{
    console.log('Inside removeProjectContoller');
    const {id} = req.params
    try{
